...
class Base:
    ...
    def add_log(self, log: str, color: str = None, context: str = "", start_time: datetime = datetime.datetime.now()) -> None:
        # TODO: overwrite
        ...
        try:
            ...
            raise MessageErrors("logs_error", context=log, language=self.settings.DEBUG_LANGUAGE)


    def get_key_words(self) -> list:
        self.add_log("get_key_words_log", color="purple", start_time=self.start_time)
    ...
    def get_intents(self) -> dict:
        ...
        """
        self.add_log("get_intents_log", color="purple", start_time=self.start_time)
        return self.intents
    ...
    def add_buttons(self, buttons: list) -> None:
        for item in buttons:
            self.add_button(item)
    
    def conversion_buttons(self) -> None:
        self.alice_buttons = []
    ...
    def get_buttons(self) -> list:
        self.add_log("get_buttons_log", color="purple", start_time=self.start_time)
        return self.buttons
    
    def get_alice_buttons(self) -> list:
        self.add_log("get_alice_buttons_log", color="purple", start_time=self.start_time)
        return self.alice_buttons

    # Storage
    def get_storage(self) -> dict:
        self.add_log("get_storage_log", color="purple", start_time=self.start_time)
        return self.storage
    ...
    def set_storage(self, key, data, overwrite=True):
        self.add_log("add_storage_log", color="purple", start_time=self.start_time)
    ...
    def update_storage_by_key(self, key, data):
        self.add_log("update_storage_log", color="purple", start_time=self.start_time)
    ...
    # Events
    def add_event(self, event: dict, where: str) -> None:
    ...
    def get_events(self) -> dict:
        self.add_log("get_events_log", color="purple", start_time=self.start_time)
        return self.events

    # Messages
    
    def add_message(self, message_name: str) -> None:
    ...
    def add_messages(self, messages: list, where: str = "add_messages") -> None:
