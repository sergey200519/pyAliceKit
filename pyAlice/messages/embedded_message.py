...
#   "get_events_log-ru": "GET: Запрос на получение 'events'",
#   "get_buttons_log-ru": "GET: Запрос на получение 'buttons'",
#   "get_key_words_log-ru": "GET: Запрос на получение 'key_words'",
#   "get_intents_log-ru": "GET: Запрос на получение 'intents'",
#   "get_storage_log-ru": "GET: Запрос на получение 'storage'",
#   "add_storage_log-ru": "Запрос на добавление в 'storage'",
#   "update_storage_log-ru": "Запрос на обнавление элемента 'storage'",
...
#   "configuration_options_log_error": "Настройки по какой то причине не были записаны",
